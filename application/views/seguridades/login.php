        ...
        <form class="form-horizontal" id="frm_login" method="post" action="<?php echo site_url("seguridades/validarUsuario"); ?>">
            <fieldset>
              ...
              <div class="form-group">
                <label class="col-md-4 control-label" for="email_usu">Email:</label>
                <div class="col-md-6">
                <input id="email_usu" name="email_usu" type="text" placeholder="Ingrese su email" class="form-control input-md" required="">
                <span class="help-block">Ej. Usuario@gmail.com</span>
                </div>
              </div>
              <!-- Password input-->
              <div class="form-group">
                <label class="col-md-4 control-label" for="password_usu">Contraseña:</label>
                <div class="col-md-6">
                  <input id="password_usu" name="password_usu" type="password" placeholder="Ingrese su contraseña" class="form-control input-md" required="">
